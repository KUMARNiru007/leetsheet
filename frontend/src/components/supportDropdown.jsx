...
const SUPPORT_CONFIG = {
  ...
  PAYEE_NAME: import.meta.env.VITE_PAYEE_NAME ,
  UPI_MSG: import.meta.env.VITE_UPI_MSG ,
};

const UpiSupportDropdown = ({ theme = "light" }) => {
  ...
  const copyUpiId = async () => {
    try {
      ...
      textArea.value = SUPPORT_CONFIG.UPI_ID;
...
export default UpiSupportDropdown;